...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? NavBarPage() : PaginaRegistroWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'paginaRegistro',
          path: '/registro',
          builder: (context, params) => PaginaRegistroWidget(),
        ),
        FFRoute(
          name: 'paginaTutorial',
          path: '/tutorial',
          requireAuth: true,
          builder: (context, params) => PaginaTutorialWidget(),
        ),
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'paginaPrincipal')
              : PaginaPrincipalWidget(
                  currentView: params.getParam('currentView', ParamType.String),
                ),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'paginaEditarPerfil',
          path: '/editar_perfil',
          requireAuth: true,
          builder: (context, params) => PaginaEditarPerfilWidget(
            userProfile: params.getParam(
                'userProfile', ParamType.DocumentReference, false, ['users']),
          ),
        ),
        FFRoute(
          name: 'paginaRestablecer',
          path: '/restablecer',
          builder: (context, params) => PaginaRestablecerWidget(),
        ),
        FFRoute(
          name: 'PaginaNotificationes',
          path: '/notificationes',
          requireAuth: true,
          builder: (context, params) => PaginaNotificationesWidget(),
        ),
        FFRoute(
          name: 'paginaFAQs',
          path: '/faqs',
          requireAuth: true,
          builder: (context, params) => PaginaFAQsWidget(),
        ),
        FFRoute(
          name: 'paginaAgregarCuenta',
          path: '/categoria',
          requireAuth: true,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'paginaAgregarCuenta')
        ...
        FFRoute(
          name: 'paginaTransacciones',
          path: '/historial',
          requireAuth: true,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'paginaTransacciones')
              : PaginaTransaccionesWidget(
                  camposDinamicos: params.getParam<dynamic>(
                      'camposDinamicos', ParamType.JSON, true),
                ),
        ),
        FFRoute(
          name: 'paginaEditarCuenta',
          path: '/editar_cuenta',
          requireAuth: true,
